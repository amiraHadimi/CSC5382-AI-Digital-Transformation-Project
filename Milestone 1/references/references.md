...
## Core Story Point Estimation Papers
1. Morakot Choetkiertikul, Hoa Khanh Dam, Truyen Tran, Trang Pham, Aditya Ghose, Tim Menzies.  
   **A Deep Learning Model for Estimating Story Points.**  
   (arXiv preprint, 2016) https://arxiv.org/abs/1609.00489  
   (IEEE TSE version, 2019) https://doi.org/10.1109/TSE.2018.2792473

2. Dr Harish Kumar Mittal, Mohd Arsalan, Puneet Garg.  
...
4. Juan Camilo Sepúlveda Montoya, Nicole Tatiana Ríos Gómez, José A. Jaramillo Villegas.  
   **Llama3SP: A resource-Efficient large language model for agile story point estimation.**  
   ...
   (DBLP record) https://dblp.org/rec/journals/nlpj/MontoyaGJ25

## Dataset
4. Agile User Story Point Estimation dataset (CSV).  
   https://github.com/mrthlinh/Agile-User-Story-Point-Estimation

## Released code/models (useful for reproducibility checks)
5. Llama3SP code/models repository: https://github.com/DEVCamiloSepulveda/llama3sp
